...
|---|---|---|---|---|
| A1 | LiDAR youyeetoo FHL-LD19 | 1 | 1 | Mesure de distance, 360° dans le plan |
...
| A4 | Moteur NEMA 17 (17HS4401) | 1 | 1 | Entraînement de l'axe de lacet |
| A5 | MPU6050 (GY-521) | 1 | 3 | Nivellement, détection de choc |
| A6 | Roulement 608ZZ (8×22×7) | 2 | 40 | Guidage de l'axe vertical |
| A7 | Insert laiton 1/4"-20 UNC | 1 | 50 | Fixation trépied |
...
| B7 | Vis M2,5×8 + écrou | 4 | — | LD19 sur le berceau (**vérifier** le filetage réel) |
...
| C3 | `lidar_cradle` | 1 | Présente le LD19 sur la tranche, serre sur la tige |
...
| FHL-LD19P | 5 000 | 12 m | Oui |
| FHL-LD19 Plus / STL-27L | 21 600 | 25 m | Oui |

Le modèle commandé est le **FHL-LD19**. La détection du verre serait un vrai
plus en intérieur (voir [operation.md](operation.md) au sujet des vitres et
miroirs) ; à considérer pour une v2.
